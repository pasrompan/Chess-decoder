...
namespace ChessDecoderApi.Tests.Services
{
    ...
    public class ImageProcessingEvaluationTests
    {
        ...
        public async Task RunControlledEvaluation_Example()
        {
            ...
            mockImageService
                .Setup(x => x.ExtractMovesFromImageToStringAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()))
...
*");
        ...
        public async Task EvaluateAsync_WithRealisticGameData_ShouldReturnReasonableMetrics()
        {
            ...
            try
            {
                ...
                mockImageService.Verify(x => x.ExtractMovesFromImageToStringAsync(tempImagePath, "English", It.IsAny<int>()), Times.Once);
